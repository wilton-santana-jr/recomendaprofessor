	...
	<body>
		...
		<div id="show-nivel" class="content scaffold-show" role="main">
			...
			<ol class="property-list nivel">
				...
				<g:if test="${nivelInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="nivel.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${nivelInstance}" field="nome"/></span>
